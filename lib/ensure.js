var ACL, EnsureRequest, JSONAdapter, Permission, Subject, _, consider,
...
EnsureRequest = (function() {
  function EnsureRequest(options) {
    this.loadSubjectPermissions = bind(this.loadSubjectPermissions, this);
    this.isAuthorized = bind(this.isAuthorized, this);
    this.isPermitted = bind(this.isPermitted, this);
    this.onDenied = bind(this.onDenied, this);
    this.redirectTo = bind(this.redirectTo, this);
    this.withPermissions = bind(this.withPermissions, this);
    this.withSubject = bind(this.withSubject, this);
  ...
  EnsureRequest.prototype.initialize = function(options) {
