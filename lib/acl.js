...
ACL = (function() {
  ...
  ACL.prototype.validate = function(ensure, acls, callback) {
    var acl, acl_validation, allow_acl, allow_acls, deny_acl, deny_acls, i, len, policy, res, result, x, y;
    this.ensure = ensure;
    allow_acls = [];
    deny_acls = [];
    acl_validation = [];
  ...
  ACL.prototype._objectValidate = function(acls) {
    ...
    for (key in acls) {
      ...
      rules = value;
      validate = (rules instanceof Array ? "_arrayValidate" : "_" + (typeof rules) + "Validate");
      if ((this[validate] != null) && indexOf.call(Object.keys(this.operators), operator) >= 0) {
